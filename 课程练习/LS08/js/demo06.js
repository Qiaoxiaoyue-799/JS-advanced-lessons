...
var func = function(n){
    if (n <= 0)
        ...
        return n * func(n - 1);//有名字
        //return n * arguments.callee(n - 1);  求阶乘
};
console.log(func(4));
...
//其具有一个指定的this值和分别的提供参数（参数列表）
function Student(username,age,sex){
    //方法.call（）方法会被调用一次
    Person.call(this,username,age);//改变this指向
    //Person.apply(this,[username,age]);  //等效
    this.sex = sex;
}
